...
function loadForm(obj) {
  ...
  $.ajax({
    url: 'http://0.0.0.0:5001/api/v1/' + s,
    type: 'POST',
    contentType: 'application/json',
    dataType: 'json',
    data: JSON.stringify(obj||{}),
...
function createDepartment(obj) {
  $.ajax({
    url: 'http://0.0.0.0:5001/api/v1/departments/',
    type: 'POST',
    contentType: 'application/json',
    dataType: 'json',
    data: JSON.stringify(obj||{}),
...
function createEmployee(obj) {
  ...
  $.ajax({
    url: 'http://0.0.0.0:5001/api/v1/departments/' + depId + '/employees',
    type: 'POST',
    contentType: 'application/json',
    dataType: 'json',
    data: JSON.stringify(obj||{}),
...
function createEmployeeTodo(obj) {
  ...
  $.ajax({
    url: 'http://0.0.0.0:5001/api/v1/employees/' + empId + '/todos/' + todoId,
    type: 'POST',
    contentType: 'application/json',
    dataType: 'json',
    data: JSON.stringify(obj||{}),
...
function createLogin(obj) {
  $.ajax({
    url: 'http://0.0.0.0:5001/api/v1/logins/',
    type: 'POST',
    contentType: 'application/json',
    dataType: 'json',
    data: JSON.stringify(obj||{}),
